    ...
    <div class="ui-tags w-full">
        ...
        <div :dusk="name"
            ...
            <input type="text"
                   ...
                   class="ui-input bg-inherit font-medium text-17px text-gray-900 rounded appearance-none" />
...
<style>
    ...
    .ui-tags .ui-container .ui-input.tagify .tagify__tag .tagify__tag__removeBtn:after { @apply text-gray-700 }
