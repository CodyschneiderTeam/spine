    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database'       => Env::get('DB_DATABASE', Env::get('APP_ENV') === 'production' ? 'forge' : (Env::get('APP_ENV') === 'testing' ? 'testing' : Text::lower(Env::get('APP_NAME')))),
            'username'       => Env::get('DB_USERNAME', Env::get('APP_ENV') === 'production' ? 'forge' : 'root'),
