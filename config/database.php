    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database'       => Env::get('DB_DATABASE', Env::get('APP_ENV', 'production') === 'production' ? 'forge' : (Env::get('APP_ENV', 'production') === 'testing' ? 'testing' : Text::lower(Env::get('APP_NAME')))),
            'username'       => Env::get('DB_USERNAME', Env::get('APP_ENV', 'production') === 'production' ? 'forge' : 'root'),
